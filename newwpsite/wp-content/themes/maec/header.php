...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo IMAGES ?>/favicon.png">
                ...
                <div class="row">
                    <div class="col-xxl-12 text-center d-none d-md-block">
                        <ul class="cta_list pt-20 pb-20">
                            <li><i class="fal fa-map-marker-alt"></i> Office #379/380 3rd Floor, Al Rehman Trade Center, Sharah-e-Liaquat, Karachi.</li>
                            
                            <li><i class="fal fa-phone"></i> 021-32413852-53 | 0336 4001119</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-6 col-md-4 col-6">
                            <div class="logo position-relative">
                                <div class="logo_bg logo_before">
                                    <a class="logo-img" href="index.html"><img src="<?php echo IMAGES ?>/logo/logo-new-01.png" alt=""></a>
                                </div>
                            </div>
                        </div>
    ...
    <aside class="slide-bar">
        ...
        <div class="offset-sidebar">
            <div class="offset-widget offset-logo mb-30">
                <a href="index.html">
                    <img src="<?php echo IMAGES ?>/logo/header_logo_one.png" alt="logo">
                </a>
            </div>
