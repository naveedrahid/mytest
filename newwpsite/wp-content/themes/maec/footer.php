<!--footer-area start-->
    <footer class="footer-area pt-100">
        <div class="container">
            <div class="row border-bottom pb-50">
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6  wow fadeInUp2 animated" data-wow-delay='.1s'>
                    <div class="footer__widget mb-30">
                        <div class="footer-log mb-30">
                            <a href="index.html" class="footer-logo"><img src="/<?php echo get_template_directory_uri(); ?>/assets/img/logo/footer-logo-01.png" alt="" style="
                                width: 100%;"></a>
                        </div>
                        <p>Sed perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor
                            laudantium totam rem aperiam eaque 
                            quae abillo inventore veritatis</p>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-3 col-sm-6  wow fadeInUp2 animated" data-wow-delay='.2s'>
                    <div class="footer__widget mb-30 pl-70">
                        <h4 class="semi-title mb-25">Quick Links</h4>
                        <ul class="fot-list">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6  wow fadeInUp2 animated" data-wow-delay='.4s'>
                    <div class="footer__widget mb-30 pl-35 pr-45">
                        <h4 class="semi-title mb-25">Newsletters</h4>
                        ...
                        <div class="foter-subscribe">
                            <form class="subscribe-form" action="form.php">
                                ...
                                <button class="theme_btn">Subscribe Now <i class="far fa-arrow-right"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6  wow fadeInUp2 animated" data-wow-delay='.5s'>
                    <div class="footer__widget mb-25 pl-85">
                        <h4 class="semi-title mb-25">Contact</h4>
                        <p class="mb-10">Sed uterspis unde omnis iste natus error voluem</p>
                        <ul class="fot-list address-list">
                            <li><a href="contact.html"><span><i class="far fa-map-marker-alt"></i></span>Office #379/380 3rd Floor Al Rehman Trade Center Sharah-e-Liaquat Karachi</a></li>
                            <li><a href="contact.html"><span><i class="far fa-envelope"></i></span>info@maelectric.com</a></li>
                            <li><a href="contact.html"><span><i class="far fa-phone-volume"></i></span>021-32413852-53</a></li>
                            <li><a href="contact.html"><span><i class="far fa-mobile-alt"></i></span>0336 4001119</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script src="/<?php echo get_template_directory_uri(); ?>/assets/js/jquery.easypiechart.js"></script>
