    ...
    */
            ...
            if($filter['type']=="choice")
            {
                ...
                foreach($field_terms as $term_name => $term)
                {
                    ...
                    else
                    {
                        ...
                        /*$field = isset( $this->form_fields[$filter_name] ) ? $this->form_fields[$filter_name] : false;
                        if ( $field ) {
                            if ( ( $field['type'] === 'post_meta' ) && ( $field['meta_type'] === 'choice' ) && ( $field['choice_is_acf'] == 1 ) ) {
                                echo $filter_name . " | <br />";
                                var_dump( $filter);
                                var_dump( $filter['cache_result_ids']);
                            }
                        }*/
    ...
    public function set_count_table() {
        ...
        foreach($this->filters as $filter_name => $filter)
        {
            ...
            foreach($field_terms as $term_name => $term)
            {
                //;echo "$filter_name | $term_name: ".$term['count']."<br />\r\n"; 
